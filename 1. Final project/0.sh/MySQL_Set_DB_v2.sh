...
# Download the database
      mkdir trackizer_DB
      wget https://raw.githubusercontent.com/Ivan2navI/L1_EPAM/main/1.%20Final%20project/.db/text_database_v2 -P ./trackizer_DB
      ls -alF ./trackizer_DB
echo "=========================================================="
echo
echo
...
echo "----------------------------------------------------------"       
      mysql -u root -p < ./trackizer_DB/text_database_v2 > ./trackizer_DB/outputCreate_trackizer.log
echo
